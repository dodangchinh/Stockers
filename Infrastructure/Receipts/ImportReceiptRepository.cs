...
{
    public class ImportReceiptRepository : IRepository<ImportExportReceipt>
    {
        public List<ImportExportReceipt> lstImportReceipts { get; set; }
        public List<Product> lstProduct { get; set; }

        public ImportReceiptRepository(List<Product> lstProduct)
        {
            lstImportReceipts = new List<ImportExportReceipt>();
        ...
        void Load()
        {
            DataProvider.pathData = "data/Receipts/ImportReceipt.xml";
            DataProvider.Open();
            ...
            foreach (XmlNode item in listNode)
            {
                ...
                lstImportReceipts.Add(importReceipt);
                Parameter.nImportReceipt++;
            }
        ...
        public void Add(ImportExportReceipt item)
        {
            ...
            string xPath = string.Format("//ImportReceipts");
