...
{
    public class ImportDateRepository : IRepository<ExpDate>
    {
        public List<ExpDate> lstImportDate {  get; set; }
        public List<Product> lstProduct { get; set; }
        public ImportDateRepository(List<Product> lstProduct)
        {
            this.lstImportDate = new List<ExpDate>();
        ...
        void Load()
        {
            ...
            string xPath = string.Format("//Imports/ExpDateDetail");
            ...
            foreach (XmlNode item in listNode)
            {
                ...
                Parameter.nImportDate++;
                lstImportDate.Add(expDate);
            }
            DataProvider.Close();
        }
        ...
        public void Add(ExpDate item)
        {
            ...
            string xPath = string.Format("//Imports");
        ...
        {
            lstImportDate.Remove(item);
            // save item in file book2.xml
            DataProvider.pathData = "data/Inventories/ExpDate.xml";
            DataProvider.Open();
            string xPath = string.Format("//Imports/ExpDateDetail[@Id='{0}']", item.Id);
        ...
        public void Update(ExpDate item)
        {
            ...
            DataProvider.nodeRoot = DataProvider.getNode("//Imports");
