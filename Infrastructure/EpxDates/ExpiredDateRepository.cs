...
{
    public class ExpiredDateRepository : IRepository<ExpDate>
    {
        public List<ExpDate> lstExportDate {  get; set; }
        public List<Product> lstProduct { get; set; }
        public ExpiredDateRepository(List<Product> lstProduct)
        {
        ...
        void Load()
        {
            ...
            string xPath = string.Format("//Expired/ExpDateDetail");
        ...
        public void Add(ExpDate item)
        {
            ...
            string xPath = string.Format("//Expired");
        ...
        public void Update(ExpDate item)
        {
            ...
            DataProvider.pathData = "data/Inventories/ExpDate.xml";
            DataProvider.Open();
            string xPath = string.Format("//Expired/ExpDateDetail[@Id='{0}']", item.Id);
            ...
            DataProvider.nodeRoot = DataProvider.getNode("//Expired");
